...
class Ui_fct_comp_4(object):
    def setupUi(self, fct_comp_4):
        ...
        self.comboBox_4_noDos = QtWidgets.QComboBox(fct_comp_4)
        self.comboBox_4_noDos.setObjectName("comboBox_4_noDos")
        self.horizontalLayout.addWidget(self.comboBox_4_noDos)
        ...
        self.comboBox_4_noDos.currentIndexChanged['int'].connect(fct_comp_4.refreshCat)
